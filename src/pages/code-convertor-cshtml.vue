    ...
    <div>
      ...
      <mu-table :fixedHeader="fixedHeader" :selectable="selectable" :showCheckbox="showCheckbox"
        ...
        <mu-thead slot="header">
          <mu-tr>
            <mu-th tooltip="C#">C#(cshtml)</mu-th>
            <mu-th tooltip="VB.NET">VB.NET(vbhtml)</mu-th>
          </mu-tr>
        </mu-thead>
    ...
    methods: {
      ...
      onFileChange(e) {
        ...
        setTimeout(() => {
          ...
          let columns = []
          let columnA = {}
          columnA.url = 'http://localhost:8080/upload/cshtml/' + this.selectedProjName + '.cshtml'
          columnA.name = this.selectedProjName + '.cshtml'
          let columnB = {}
          columnB.url = 'http://localhost:8080/upload/vbhtml/' + this.selectedProjName + '.vbhtml'
          columnB.name = this.selectedProjName + '.vbhtml'
